...
medias_by_specialization.each do |name, urls|
  specialization = Specialization.find_by(name: name)
  next unless specialization

  3.times do
    Multimedia.create!(
      portfolio: specialization.architects.sample.portfolio,
      type_media: urls.sample,
